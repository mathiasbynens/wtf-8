(function(root) {
	...
	/** The `wtf8` object to test */
	var wtf8 = root.wtf8 || (root.wtf8 = (
		wtf8 = load('../wtf-8.js') || root.wtf8,
		wtf8 = wtf8.wtf8 || wtf8
	));
	...
	test('encode/decode', function() {
		forEach(data, function(object) {
			...
			equal(
				object.encoded,
				wtf8.encode(object.decoded),
				'Encoding: ' + description
			);
			equal(
				object.decoded,
				wtf8.decode(object.encoded),
		...
		raises(
			...
			Error,
			'Error: invalid WTF-8 detected'
		);
		raises(
			function() {
				wtf8.decode('\xE9\x00\x00');
			},
			Error,
